...
/******/ 	__webpack_require__.p = "//checkers/";
...
var sliceBuffer = __webpack_require__(92);
var after = __webpack_require__(91);
var utf8 = __webpack_require__(162);

var base64encoder;
if (global && global.ArrayBuffer) {
  base64encoder = __webpack_require__(94);
}
...
var _withRouter2 = __webpack_require__(148);
...
var _useRoutes2 = __webpack_require__(147);
...
var _applyRouterMiddleware2 = __webpack_require__(138);

var _applyRouterMiddleware3 = _interopRequireDefault(_applyRouterMiddleware2);

var _browserHistory2 = __webpack_require__(139);

var _browserHistory3 = _interopRequireDefault(_browserHistory2);

var _hashHistory2 = __webpack_require__(143);
...
var _getRouteParams = __webpack_require__(142);
...
var hasCORS = __webpack_require__(111);
...
var getPrototype = __webpack_require__(117),
    isHostObject = __webpack_require__(118),
...
var _matchRoutes = __webpack_require__(146);
...
var json = __webpack_require__(116);
...
var CheckersTable = function (_React$Component) {
	_inherits(CheckersTable, _React$Component);

	function CheckersTable(p) {
		_classCallCheck(this, CheckersTable);
	...
	_createClass(CheckersTable, [{
		...
		value: function render() {
			...
			var keysMap = _state.keysMap;
			var letters = _state.letters;
			...
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					'div',
					{ className: 'numbers', style: { fontSize: boardSize / 50 } },
				...
				_react2.default.createElement(
					'div',
					{ className: 'letters', style: { fontSize: boardSize / 50 } },
					[].concat(_toConsumableArray(Array(Math.sqrt(keysMap.length * 2)).keys())).map(function (i) {
						return _react2.default.createElement(
							'span',
...
var _deepEqual = __webpack_require__(97);
...
var _combineReducers = __webpack_require__(151);

var _combineReducers2 = _interopRequireDefault(_combineReducers);

var _bindActionCreators = __webpack_require__(150);
...
var _temp = __webpack_require__(37);
...
var _chatmessage = __webpack_require__(83);
...
var _newgame = __webpack_require__(85);
...
var Li = function Li(_ref) {
	...
	return _react2.default.createElement(
		...
		_react2.default.createElement(
			'a',
			{ 'data-to': name, onClick: callback },
			_locale2.default[name]
		)
	);
};
...
function HomeView(_ref2) {
	...
	var LowerArbitraryComponent = window.RR[lowerTabName];
	return _react2.default.createElement(
		'div',
		{ className: 'col-md-12' },
		_react2.default.createElement(
		...
		_react2.default.createElement(
			...
			_react2.default.createElement(
				...
				_react2.default.createElement(
					...
					upperLinks.map(function (link) {
						return _react2.default.createElement(Li, { key: link, active: upperTabName === link, name: link, callback: setUpperTabHandler });
					})
				),
				_react2.default.createElement(
					'div',
...
var _Match = __webpack_require__(77);
...
var Live = function Live(_ref) {
	...
	return _react2.default.createElement(
		...
		_react2.default.createElement(
			...
			data.length > 0 ? data.map(function (match) {
				return _react2.default.createElement(_Match2.default, _extends({ key: match.roomId }, match));
			}) : _react2.default.createElement(
				'div',
				{ className: 'spinner' },
				_locale2.default.noLiveGames
			)
		)
	);
};
...
function NewGameView(_ref) {
	...
	var spans = function spans(variable, index, type) {
		return _react2.default.createElement(
			'span',
			{ key: index, 'data-name': type, className: 'type ' + variable.toLowerCase() },
			variable
		);
	};
	return _react2.default.createElement(
		'nav',
		{ id: 'NewGame', className: 'nav nav-tabs nav-justified' },
		_react2.default.createElement(
			'li',
			{ className: 'col-md-6' },
			_react2.default.createElement(
			...
			_react2.default.createElement(
				'div',
				{ className: 'type-panel' + (activePanel === 'typePanel' ? ' active' : '') },
				types.map(function (type, i) {
					return spans(type, i, 'selectedType');
				})
			)
		),
		_react2.default.createElement(
			...
			_react2.default.createElement(
				'div',
				{ className: 'time-panel' + (activePanel === 'timePanel' ? ' active' : '') },
				times.map(function (time, i) {
					return spans(time, i, 'selectedTime');
				})
			)
		),
		_react2.default.createElement(
...
var Entry = function (_React$Component) {
	...
	function Entry(p) {
		...
		var _this = _possibleConstructorReturn(this, (Entry.__proto__ || Object.getPrototypeOf(Entry)).call(this, p));

		_this.state = { timeLeft: Math.round((p.startsAt - Date.now()) / (60 * 1000)) };
		return _this;
	}
	...
	_createClass(Entry, [{
		...
		value: function render() {
			...
			var timeframe = _props.timeframe;
			...
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					"span",
					{ className: "timeframe" },
					timeframe.total + "|" + timeframe.turn
				),
				_react2.default.createElement(
					"span",
...
var Tournament = function (_React$Component) {
	...
	function Tournament(p) {
		_classCallCheck(this, Tournament);

		var _this = _possibleConstructorReturn(this, (Tournament.__proto__ || Object.getPrototypeOf(Tournament)).call(this, p));

		_this.state = { entries: [{ type: 'Test', timeframe: { total: 15, turn: 0 }, startsAt: Date.now() + 1000 * 60 * 7, players: 3 }, { type: 'Test', timeframe: { total: 15, turn: 0 }, startsAt: Date.now() + 1000 * 60 * 83, players: 3 }, { type: 'Test', timeframe: { total: 10, turn: 60 }, startsAt: Date.now() + 1000 * 60 * 52, players: 3 }, { type: 'Test', timeframe: { total: 10, turn: 3 }, startsAt: Date.now() + 1000 * 60 * 35, players: 3 }, { type: 'Test', timeframe: { total: 45, turn: 15 }, startsAt: Date.now() + 1000 * 60 * 12, players: 3 }]
		};
		return _this;
	}
	...
	_createClass(Tournament, [{
		...
		value: function render() {
			...
			return _react2.default.createElement(
				'div',
				{ id: 'Tournament' },
				entries.map(function (data, i) {
					return _react2.default.createElement(_Entry2.default, _extends({ key: i }, data));
				})
			);
		}
	}]);
...
window.RR = _extends({}, window.RR, { Tournament: Tournament });
...
var Checker = function (_React$Component) {
	_inherits(Checker, _React$Component);

	function Checker() {
		_classCallCheck(this, Checker);

		return _possibleConstructorReturn(this, (Checker.__proto__ || Object.getPrototypeOf(Checker)).apply(this, arguments));
	}
	...
	_createClass(Checker, [{
		...
		key: 'render',
		value: function render() {
			return _react2.default.createElement('div', { className: 'checker ' + this.props.className, id: this.props.id, 'data-checker': this.props.checker, onClick: this.handleClick.bind(this) });
		}
	}]);
...
var _CheckersTable = __webpack_require__(35);
...
var Match = function (_Component) {
	...
	_createClass(Match, [{
		...
		key: 'resizeBoard',
		value: function resizeBoard() {
			var boardSize = Math.min(window.innerHeight, window.innerWidth) * 8 / 10;
...
var SinglePlayerMatch = function (_Component) {
	_inherits(SinglePlayerMatch, _Component);

	function SinglePlayerMatch(p) {
		_classCallCheck(this, SinglePlayerMatch);

		var _this = _possibleConstructorReturn(this, (SinglePlayerMatch.__proto__ || Object.getPrototypeOf(SinglePlayerMatch)).call(this, p));

		var player = { name: 'You' /* window.prompt('You\'re name?', 'Fixy')*/, rating: null, side: 1 };
		_this.state = {
			// player options
			playerSide: 0,
			player: player,
	...
	_createClass(SinglePlayerMatch, [{
		key: 'componentWillMount',
		value: function componentWillMount() {
			var _this2 = this;
...
var _HomeView = __webpack_require__(73);
...
var _socket = __webpack_require__(152);
...
var Home = function (_React$Component) {
	...
	_createClass(Home, [{
		...
		key: 'playHandler',
		value: function playHandler(data) {
			var socket = this.state.socket;
...
exports.default = (0, _reactRouter.withRouter)((0, _reactRedux.connect)(null, function (dispatch) {
	return {
...
var _NewGameView = __webpack_require__(75);
...
var NewGame = function (_React$Component) {
	...
	function NewGame(p) {
		...
		var _this = _possibleConstructorReturn(this, (NewGame.__proto__ || Object.getPrototypeOf(NewGame)).call(this, p));

		var types = _locale2.default.matchTypes; // ['Russian', 'World'];
		var times = ['15|0', '10|0'];
		_this.state = {
	...
	_createClass(NewGame, [{
		...
		value: function handleClick(e) {
			...
			if (checking.panel.includes(e.target.name)) {
				...
				var _state = {};
				_state[e.target.dataset.name] = e.target.textContent;
				this.setState(_state);
			} else this.setState({ activePanel: false });
		}
	}, {
		key: 'play',
		value: function play() {
			var _state2 = this.state;
			var selectedType = _state2.selectedType;
			var selectedTime = _state2.selectedTime;
			var handler = this.props.handler;

			handler({ type: 'play', selectedType: selectedType, selectedTime: selectedTime });
		}
	}, {
		key: 'render',
		value: function render() {
...
window.RR = _extends({}, window.RR, { 'Play': NewGame });
...
var _pathing = __webpack_require__(89);
 ...
 */
	...
	if (piece.checker % 2 === 0 && piece.checker !== 0 /* && piece.paths.length === 0*/) return 1;
		...
		case 'hideMoves':
			Object.keys(table).map(function (pos) {
				table[pos] = _extends({}, table[pos], {
					className: table[pos].paths && table[pos].paths.length > 0 && game.turn * table[pos].checker > 0 ? game.turn * game.playerSide > 0 ? 'can-move' : '' : '',
					consume: null
				});
			});
			return _extends({}, state, {
		...
		case 'move':
			...
			return _extends({}, state, {
				game: _extends({}, game, {
					table: _extends({}, table),
					turn: turn,
					sequentialWhiteMoves: sequentialWhiteMoves
				})
			});
		case 'updateAllPaths':
			var won = null;
...
var _directions = __webpack_require__(88);

var _directions2 = _interopRequireDefault(_directions);

var _paths = __webpack_require__(90);

var _paths2 = _interopRequireDefault(_paths);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

function findAllPaths(table, game) {
	var turn = game.turn;
	var rules = game.rules;
	var playerSide = game.playerSide;
	...
	for (var pieceKey in table) {
		...
		if (table[pieceKey].checker * turn > 0 /* && Object.keys(table[pieceKey].connected).some(d => {
				...
				if (table[pieceKey].checker % 2 !== 0) newTable[pieceKey] = _extends({}, table[pieceKey], {
			...
			} else newTable[pieceKey] = table[pieceKey];
	} // if (ruledVal
	...
	if (rules.onlyBeatIfPossible && !bWhiteMovesOnly) Object.keys(newTable).filter(function (key) {
	...
	if (t1 - t0 > 5) console.log('Pathing took ' + (t1 - t0) + ' milliseconds.');
	// debugger;
...
var _wrapActionCreators = __webpack_require__(127);
...
var _makeStateWithLocation = __webpack_require__(57);
...
module.exports = __webpack_require__(159)(global || window || undefined);
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(3)))
...
_reactDom2.default.render(_react2.default.createElement(_root2.default, { store: _configureStore2.default, history: _reactRouter.browserHistory }), document.getElementById('root'));
